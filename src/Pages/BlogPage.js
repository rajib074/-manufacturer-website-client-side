    ...
    return (
        <>
            <div className='container mx-auto px-14 my-24'>
                <div className="collapse max-w-3xl mx-auto">
                    <input type="checkbox" className="peer" />
                    <div className="collapse-title text-primary bg-yellow-50">
                        How will you improve the performance of react Application?
                    </div>
                    <div className="collapse-content bg-yellow-50">
                ...
                <div className="collapse max-w-3xl mx-auto mt-8">
                    <input type="checkbox" className="peer" />
                    <div className="collapse-title text-primary bg-yellow-50">
